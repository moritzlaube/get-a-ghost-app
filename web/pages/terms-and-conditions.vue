...
div.container.flow
  ...
  p Last updated: November 07, 2021
  ...
  ul
    li
      p
        strong Application
        |  means the software program provided by the Company downloaded by You on any electronic device, named Get A Ghost
    li
      p
    ...
    li
      p
        strong Country
        |  refers to: Berlin,  Germany
    li
      p
        strong Company
        |  (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Dots &amp; Dashes, Eberhard-Roters-Platz 14, 10965 Berlin.
    li
      p
        strong Device
  ...
  h1 United States Federal Government End Use Provisions
  p
  ...
  ul
    li By email: hi@get-a-ghost.com
</template>
